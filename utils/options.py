...
def get_args():
    ...
    parser.add_argument("--cmt_depth", type=int, default=6, help="cross modal transformer self attn layers")
    ...
    parser.add_argument("--ways", type=int, default=0)
    parser.add_argument("--m_ratio", type=float, default=0.15)
